In this project, the use of sentiment analysis will be performed on data gathered from social media platforms, particularly whether the tweets gathered are positive, or negative. 
